...
public class NotificationCollectorMonitorService extends Service {
    ...
    private void ensureCollectorRunning() {
        ComponentName collectorComponent = new ComponentName(this, /*NotificationListenerService Inheritance*/ MyNotifiService.class);
    ...
    private void toggleNotificationListenerService() {
        ...
        ComponentName thisComponent = new ComponentName(this, /*getClass()*/ MyNotifiService.class);
